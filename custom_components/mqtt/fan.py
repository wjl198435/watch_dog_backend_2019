...
class MqttFan(
    ...
    async def _subscribe_topics(self):
        ...
        for key, tpl in list(self._templates.items()):
            _LOGGER.info("key={},tpl={}".format(key,tpl))
            if tpl is None:
        ...
        def state_received(msg):
            ...
            _LOGGER.info(self._payload["STATE_ON"])
        ...
        _LOGGER.info("-----------------self._topic[CONF_SPEED_STATE_TOPIC] ={}".format(self._topic[CONF_SPEED_STATE_TOPIC] ))
        ...
        for topic in topics:
            _LOGGER.info("-----------------topic={}".format(topic))
